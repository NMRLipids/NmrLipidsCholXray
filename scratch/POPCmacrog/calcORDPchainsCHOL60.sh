#!/bin/bash
wget https://zenodo.org/record/13877/files/md_chol60.tpr
wget https://zenodo.org/record/13877/files/md_chol60.xtc
tprname=md_chol60.tpr
trajname=md_chol60.xtc
mappingFILE=../../MAPPING/mappingPOPCmacrog.txt
trajgroname=analTMP60.gro
sn1outname=OrderParamSN1chol60.dat
sn2outname=OrderParamSN2chol60.dat
