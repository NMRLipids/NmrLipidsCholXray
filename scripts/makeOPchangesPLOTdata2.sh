...
paste ../../MATCH/Data/Lipid_Bilayers/POPC/T298K/MODEL_Berger/sn-1_Order_Parameters_Simulation.dat ../../MATCH/Data/Lipid_Bilayers/POPC+15%chol/T300K/MODEL_Berger/sn-1_Order_Parameters_Simulation.dat ../../MATCH/Data/Lipid_Bilayers/POPC+50%chol/T298K/MODEL_Berger/sn-1_Order_Parameters_Simulation.dat | awk '{if(NR==1)print "0   15   50"; else print $2-$2"   "$5-$2"   "$8-$2}' > ../DATA/OPcholBERGERsn-1_1change.dat
psc -r < ../DATA/OPcholBERGERsn-1_1change.dat | sc -W% - > ../DATA/OPcholBERGERsn-1_1transposeCHANGE.dat
...
paste $POPCsn1DATA $POPCchol11percSN1data $POPCchol44percSN1data $POPCchol50percSN1data $POPCchol56percSN1data | awk 'BEGIN{print "0   11   44    50    56"}{print $2-$2"   "$5-$2"   "$8-$2"    "$11-$2"   "$14-$2}' > ../DATA/OPcholMACROGsn-1_1change.dat
psc -r < ../DATA/OPcholMACROGsn-1_1change.dat | sc -W% - > ../DATA/OPcholMACROGsn-1_1transposeCHANGE.dat
...
paste $POPCsn1DATA $POPCchol20percSN1data $POPCchol30percSN1data $POPCchol40percSN1data $POPCchol50percSN1data | awk 'BEGIN{print "0   20   30   40  50"}{print $2-$2"   "$5-$2"   "$8-$2"   "$11-$2"    "$14-$2}' > ../DATA/OPcholCHARMM36sn-1_1change.dat
psc -r < ../DATA/OPcholCHARMM36sn-1_1change.dat | sc -W% - > ../DATA/OPcholCHARMM36sn-1_1transposeCHANGE.dat
