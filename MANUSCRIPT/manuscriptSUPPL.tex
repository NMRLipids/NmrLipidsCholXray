...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=8.7cm]{../FIGS/firstmin.pdf}
    \caption{\label{SIfig:firstmin}%
    \textbf{Effecf of CHOL on the location of the first minima in the form factor.}
    The minima are extracted from the form factors (Fig.~\ref{SIfig:scattering}) from experiment and simulation with the \texttt{findpeaks} function in Matlab and interpolated to all CHOL concentrations.
    }
\end{figure}
