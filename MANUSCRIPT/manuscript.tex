...
\todo{We should emphasize the validation aspect of intermolecular interactions in binary lipid mixtures in the introduction.}
...
\todo{To be written once we have agreed on the used measure.}
