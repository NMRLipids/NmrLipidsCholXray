...
echo MEMB System | gmx trjconv -n ../index.ndx -f ../$trajname -s ../$tprname -fit progressive -o ANALtraj.xtc
#cp ../electronsLIPID.dat ./electrons.dat
echo SOL  | gmx density -n ../index.ndx -f ANALtraj.xtc -s ../$tprname -ei electrons.dat -dens electron -o electronDENSITYsol.xvg -xvg none -sl 100
echo MEMB | gmx density -n ../index.ndx -f ANALtraj.xtc -s ../$tprname -ei electrons.dat -dens electron -o electronDENSITYlipid.xvg -xvg none -sl 100
