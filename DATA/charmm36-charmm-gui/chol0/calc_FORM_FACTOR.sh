...
echo non-Water System | gmx trjconv -n ../index.ndx -f ../trajectory.xtc -s ../topol.tpr -fit progressive -o ANALtraj.xtc
#cp ../electronsLIPID.dat ./electrons.dat
echo SOL  | gmx density -n ../index.ndx -f ANALtraj.xtc -s ../topol.tpr -ei electrons.dat -dens electron -o electronDENSITYsol.xvg -xvg none -sl 100
